    ...
    class Task4
    {
        ...
        public Task4()
        {
            ...
            if (tackType)
                ...
                template = $"На станциях отправления поездов находится {n} автоматов для продажи билетов. Вероятность выхода из строя одного автомата в течение часа равна {p}. Найти вероятность того, что в течение часа выйдут из строя: а) {k} автоматов; б) от {k1} до {k2} автоматов. Найти наиболее вероятное число вышедших из строя автоматов.";
